    ...
    Column(modifier = Modifier.fillMaxSize()) {
        ...
        Row(
            modifier = Modifier
                ...
                .navigationBarsPadding(), //calculates the navigation bar padding and adds it here to bottom of row
            ...
            Row (verticalAlignment = Alignment.CenterVertically) {
                ...
                if (buttonState.value[0].isNotEmpty()) { // hide it
